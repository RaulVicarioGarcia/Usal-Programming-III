...
public class Vista {
    ...
    public void mostrarMenu() {
        ...
        System.out.println("2. Mostrar listado ordenado por autor y año.");
        System.out.println("3. Añadir un libro.");
        System.out.println("4. Eliminar un libro.");
        System.out.println("5. Modificar un libro.");
        System.out.println("6. Exportar libros.");
    ...
    public void mostrarLibrosOrdenados() {
        List<String> listado = controlador.obtenerListadoOrdenadoLibros();
        if (listado.isEmpty()) {
            System.out.println("No hay libros en la biblioteca.");
        } else {
            System.out.println("\nListado de libros ordenado por autor y año:");
